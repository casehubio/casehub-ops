...
class IoTApprovalEvaluatorTest {
    ...
    void physicalDeviceAutoApproves() {
        ...
        var node = new DesiredNode(NodeId.of("dev-1"), spec, io.casehub.desiredstate.api.HumanGating.ALL);
    ...
    void deviceConfigAutoApproves() {
        ...
        var node = new DesiredNode(NodeId.of("dev-1-config"), spec, io.casehub.desiredstate.api.HumanGating.NONE);
